...
/** Returns an attributed string created by using the given format string as a template into which the remaining argument values are substituted according to the current locale.
 ...
 @param ... A comma-separated list of arguments to substitute into \p format .
 */
+ (nullable instancetype)localizedStringWithFormat:(nonnull NSString *)format, ... NS_FORMAT_FUNCTION(1,2);
 ...
 */
+ (nullable instancetype)localizedStringWithBaseAttributes:(nullable NSDictionary *)baseAttributes format:(nonnull NSString *)format, ... NS_FORMAT_FUNCTION(2,3);
...
/** Returns an attributed string created by using the given format string as a template into which the remaining argument values are substituted.
 ...
 @param ... A comma-separated list of arguments to substitute into \p format .
 */
- (nullable instancetype)initWithBaseAttributes:(nullable NSDictionary *)baseAttributes format:(nonnull NSString *)format locale:(nullable NSLocale *)locale, ... NS_FORMAT_FUNCTION(2,4);
...
/** Returns an attributed string created by using the given format string as a template into which the remaining argument values are substituted.
 ...
 @param argList A list of arguments to substitute into \p format .
 */
- (nullable instancetype)initWithBaseAttributes:(nullable NSDictionary *)baseAttributes format:(nonnull NSString *)format locale:(nullable NSLocale *)locale arguments:(va_list)argList NS_FORMAT_FUNCTION(2,0);
